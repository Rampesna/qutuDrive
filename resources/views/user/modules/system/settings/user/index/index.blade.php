...
@section('title', __('sidebar.settings.users') . ' | ')

@section('subheader')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-5 my-1">{{ __('sidebar.settings.users') }}</h1>
        </div>
        ...
        <div class="col-xl-3 mb-5 text-end">
            <div class="row">
                <div class="col-xl-12 d-grid">
                    <button class="btn btn-primary" onclick="createUser()">Yeni Kullanıcı Oluştur</button>
                </div>
            </div>
        </div>
    </div>
...
@section('customStyles')
    @include('user.modules.system.settings.user.index.components.style')
@endsection

@section('customScripts')
    @include('user.modules.system.settings.user.index.components.script')
@endsection

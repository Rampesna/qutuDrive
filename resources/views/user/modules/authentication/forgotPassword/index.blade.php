            ...
            <div class="form w-100">
                ...
                <div class="fv-row mb-10">
                    <div class="d-flex flex-stack mb-2">
                        <label for="email" class="form-label fw-bolder text-dark fs-6 mb-0">
                            E-posta Adresiniz
                        </label>
                        <a href="{{ route('user.web.authentication.login.index') }}" class="link-primary fs-6 fw-bolder" tabindex="-1">
                            Giriş Yapın
                        </a>
                    </div>
                ...
                <div class="text-center">
                    <button type="button" id="ResetPasswordButton" class="btn btn-lg btn-primary w-100 mb-5">
                        Gönder
                    </button>
                </div>
            </div>

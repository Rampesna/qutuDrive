...
@section('content')
    ...
    @include('user.modules.form.index.modals.createForm')
    @include('user.modules.form.index.modals.updateForm')
    @include('user.modules.form.index.modals.deleteForm')
...
@section('customStyles')
    @include('user.modules.form.index.components.style')
@endsection

@section('customScripts')
    @include('user.modules.form.index.components.script')
@endsection
